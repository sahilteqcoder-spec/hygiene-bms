...
const s = StyleSheet.create({
  ...
  muted: { color: "#555" },
  border: { borderBottomWidth: 1, borderColor: "#ccc", paddingBottom: 8, marginBottom: 8 },
  thead: { flexDirection: "row", backgroundColor: "#f3f4f6", borderTopWidth: 1, borderBottomWidth: 1, borderColor: "#ccc", paddingVertical: 4 },
  ...
  grand: { flexDirection: "row", justifyContent: "space-between", borderTopWidth: 1, borderColor: "#ccc", paddingTop: 3, marginTop: 3 },
